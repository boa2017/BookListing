...
public class QueryUtils {
    ...
    private static Context mContext = BookActivity.mContext;
    ...
    public static ArrayList<BookItem> fetchBookData(String requestURL) {
        ...
        ArrayList<BookItem> bookItem = extractBookData(jsonResponse);
    ...
    private static ArrayList<BookItem> extractBookData(String bookDataJSON) {
        ...
        ArrayList<BookItem> bookItem = new ArrayList<BookItem>();
        ...
        try {
            ...
            errorMessage = "Problem parsing the BookItem JSON results. JSONException: " + e;
        }

        // Return the list of BookItem
        return bookItem;
    }
}